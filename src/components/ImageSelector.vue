<template>
    <label :class="[{ 'border-solid shadow-lg scale-105': dragOver }, { 'border-dashed': !dragOver }]"
           class="bg-white bg-opacity-20  w-32 h-32  rounded-full flex flex-col justify-center items-center transition-all duration-300 transform relative overflow-hidden cursor-pointer">
        ...
        <!-- Mascara -->
        <div class="absolute w-full h-full bg-center bg-cover flex items-center justify-center group"
             ...
             @dragleave="dragLeave"
             @drop="drop">
            <div class="w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100  transition-opacity duration-300"
